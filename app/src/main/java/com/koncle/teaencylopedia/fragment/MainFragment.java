...
public class MainFragment extends Fragment implements HasName{
    private String name;
    private String url;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MyRecycleViewAdapter myRecycleViewAdapter = new MyRecycleViewAdapter(this.getContext(), 1, url);
